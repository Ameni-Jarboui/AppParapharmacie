...
class Avoirs extends StatefulWidget {
  Avoirs({Key? key}) : super(key: key);

  @override
  _AvoirsState createState() => _AvoirsState();
}

class _AvoirsState extends State<Avoirs> {
      ...
      body:  Center(
        child: Column(
          children: [
            ...
            Text("avoirs",style: TextStyle(fontSize: 29),)
