...
class Produits extends StatefulWidget {
  Produits({Key? key}) : super(key: key);
...
class _ProduitsState extends State<Produits> {
  ...
  List<dynamic> cartProducts = []; // Liste des produits dans le panier
                ...
                if (cartProducts.isNotEmpty)
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final produit = cartProducts[index];
                      return ListTile(
                        title: Text(produit['Designation']),
                        subtitle: Text('Sans Promo: ${produit['SansPromo']}'),
                        trailing: Row(
